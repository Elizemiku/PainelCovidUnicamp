...
```{r }
# puxando o codigo do tweet.R para usar no codigo reativo em shiny na aba de nuvem de palavras
source("tweet.R")
```
...
pickerInput(
  inputId = "conta",
  label = "Escolha até 4 contas para descobrir quais palavras 
  foram digitadas durante a pandemia:",
  choices = contas,
  multiple = TRUE,
...
p("Palavras encontradas nos últimos 1000 tweets de cada conta")
...
datatable(filtro_contas() %>% arrange(desc(freq)) %>% distinct(),

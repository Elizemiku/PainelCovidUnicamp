...
Covid-19 {data-navmenu="Análise de dados" data-icon="fa-notes-medical"}
=====================================  
...
filtro_cidades <- reactive({
    ...
    mutate(MediaNovos = estatisticas_moveis(.$casos_novos),
...
pickerInput(
  inputId = "conta",
  label = "Escolha até 4 contas para descobrir quais palavras relacionadas à pandemia foram encontradas nas contas destes usuários:",
  choices = contas,
  multiple = TRUE,
...
p("Tente atualizar a página caso a nuvem de palavras não carregue!")
```
...
output$nuvem <- renderWordcloud2({
  if(is.null(input$conta)){
    ...
    wordcloud2(filtro_contas(), size=3.9, minSize = 2.5, 
